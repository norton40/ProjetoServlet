...
public class JuroComposto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Juro Composto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>");
            out.println("CÁLCULO DE JUROS Composto");
            out.println("</h1>");
            out.println("<a href='index.html'> PÁGINA INICIAL </a>");
            out.println("<BR><a href='juroSimples'>JUROS SIMPLES </a>");
            out.println("<HR/>");
            out.println("<form>");
            ...
            if(request.getParameter("vai")!=null){
                try {
                    ...
                    for(int j=1; j <= t; j++){
                        ...
                        BigDecimal bd = new BigDecimal(m).setScale(3, RoundingMode.HALF_EVEN);
                        out.println("<br>");
                        out.println("<tr>");
